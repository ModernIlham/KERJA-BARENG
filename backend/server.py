...
# Import Routers
from routes import auth, barang, pegawai, pegawai_photos, transaksi, dashboard, banding, opname, laporan, settings, referensi, persediaan, persediaan_transaksi, laporan_bmn, surat, dokumen, kepegawaian, tasks, activity, kib, aset_pegawai
